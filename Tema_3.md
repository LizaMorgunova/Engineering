...
## Выводы
Были созданы две переменные с возможностью ввода их в консоль. Далее было проверено, больше или равна ли первая переменная второй. Если да, то выводится "Выполняется". Если нет, то "Не выполняется".
